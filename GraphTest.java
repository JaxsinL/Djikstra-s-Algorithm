...
public class GraphTest {
    ...
    /**
     * Checks the distance/total weight cost from the vertex C to A.
     */
    @Test
    public void testPathCostCtoA() {
        assertTrue(graph.getPathCost("C", "A") == 2);
    }
    ...
    /**
     * Checks the distance/total weight cost from the vertex F to E.
     */
    @Test
    public void testPathCostFtoE() {
        assertTrue(graph.getPathCost("F", "E") == 4);
    }
